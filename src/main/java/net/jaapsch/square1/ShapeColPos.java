...
public class ShapeColPos {
	...
	private boolean edgesFlag; // set if the 4 coloured pieces are edges, clear for corners.

	ShapeColPos(ShapeTranTable stt0) {
		stt = stt0;
	}

	// initialise from shape index and colour choice index, using either coloured
	// edges or corners.
