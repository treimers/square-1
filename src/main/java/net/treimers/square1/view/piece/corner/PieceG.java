...
/**
 * Instances of this class are used as piece G objects in the Square-1 application.
 */
public class PieceG extends AbstractCornerPiece {
	 ...
	 */
	public PieceG(int rotate, int position, ColorBean colorBean) {
