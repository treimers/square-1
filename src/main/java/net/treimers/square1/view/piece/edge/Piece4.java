...
/**
 * Instances of this class are used as piece 4 objects in the Square-1 application.
 */
public class Piece4 extends AbstractEdgePiece {
	 ...
	 */
	public Piece4(int rotate, int position, ColorBean colorBean) {
