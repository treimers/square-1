...
/**
 * Instances of this class are used as piece F objects in the Square-1 application.
 */
public class PieceF extends AbstractCornerPiece {
	 ...
	 */
	public PieceF(int rotate, int position, ColorBean colorBean) {
