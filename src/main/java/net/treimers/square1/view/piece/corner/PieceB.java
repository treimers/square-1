...
/**
 * Instances of this class are used as piece B objects in the Square-1 application.
 */
public class PieceB extends AbstractCornerPiece {
	 ...
	 */
	public PieceB(int rotate, int position, ColorBean colorBean) {
