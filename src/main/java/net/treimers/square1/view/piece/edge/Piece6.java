...
/**
 * Instances of this class are used as piece 6 objects in the Square-1 application.
 */
public class Piece6 extends AbstractEdgePiece {
	 ...
	 */
	public Piece6(int rotate, int position, ColorBean colorBean) {
